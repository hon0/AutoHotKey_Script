...
Numpad0::
{
	SendInput {RControl Down}{Numpad0 Down}{RControl Up}
	KeyWait Numpad0
	SendInput {RControl Down}{Numpad0 Up}{RControl Up}
	Return
}

Numpad1::
{
	SendInput {RControl Down}{Numpad1 Down}{RControl Up}
	KeyWait Numpad1
	SendInput {RControl Down}{Numpad1 Up}{RControl Up}
	Return
}
