...
{ ; Keyboard remapping
	...
	{ ; Layer 1 "x" remapping
		...
		else
		{
			...
			ControlSend, Edit4, 12, The Settlers 7 Paths to a Kingdom Prima Official Guide.pdf - Foxit Reader
			ControlSend, Edit4, {NumpadEnter}, The Settlers 7 Paths to a Kingdom Prima Official Guide.pdf - Foxit Reader
		}
		return
	}
	...
	{ ; Layer 1 "c" remapping
		~c::
		ControlSend, FoxitDocWnd1, {LControl Down}{g}{LControl Up}, The Settlers 7 Paths to a Kingdom Prima Official Guide.pdf - Foxit Reader
		ControlSend, Edit4, 17, The Settlers 7 Paths to a Kingdom Prima Official Guide.pdf - Foxit Reader
		ControlSend, Edit1, {Enter}, The Settlers 7 Paths to a Kingdom Prima Official Guide.pdf - Foxit Reader
		ControlSend, FoxitDocWnd1, {Enter}, The Settlers 7 Paths to a Kingdom Prima Official Guide.pdf - Foxit Reader		
		return
	}
