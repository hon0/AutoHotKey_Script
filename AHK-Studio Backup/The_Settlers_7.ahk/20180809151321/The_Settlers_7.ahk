...
{ ; Global remapping
	...
	{ ; Layer 1 "c" remapping
		~c::
		sleep 32		
		ControlSend, UIX:Window2, {LControl Down}{LShift Down}{n}{LControl Up}{LShift Up}, The Settlers 7 Paths to a Kingdom Prima Official Guide - PDF-XChange Editor
		ControlSend,UIX:Window2, 19, Aller à la page 
		ControlSend,UIX:Window2, {NumpadEnter}, Aller à la page
		sleep 100
		return
	}
	...
	ControlSend, UIX:Window2, 19, ahk_exe PDFXEdit.exe
	;ControlSend,, {NumpadEnter}, Aller à la page
	return
