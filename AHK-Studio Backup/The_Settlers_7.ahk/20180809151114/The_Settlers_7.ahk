...
{ ; Global remapping
	...
	{ ;Layer 1 "x" remapping
		...
		else
		{
			...
			sleep 32
			SendInput {x up}
			ControlSend, ahk_parent, {LControl Down}{LShift Down}{n}{LControl Up}{LShift Up}, ahk_exe PDFXEdit.exe			
	...
	{ ; Layer 1 "c" remapping
		...
		ControlSend,ahk_parent, 19, Aller à la page 
		ControlSend,ahk_parent, {NumpadEnter}, Aller à la page
		sleep 100
		return
	}
	...
	ControlSend, Scintilla1, 19, The Settlers 7 Paths to a Kingdom Prima Official Guide - PDF-XChange Editor
	;ControlSend,, {NumpadEnter}, Aller à la page
	return
