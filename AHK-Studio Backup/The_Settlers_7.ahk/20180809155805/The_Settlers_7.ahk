...
{ ; Global remapping
	...
	ControlSend, UIX:Window2, {LControl Down}{t}{LControl Up}, The Settlers 7 Paths to a Kingdom Prima Official Guide - PDF-XChange Editor
	;ControlSend,, {NumpadEnter}, Aller à la page
	return
	...
	ControlGet, controlID, Hwnd,,The Settlers 7 Paths to a Kingdom Prima Official Guide - PDF-XChange Editor
	
	; Focuses on chrome without breaking focus on what you're doing
	ControlFocus,,ahk_id %controlID%
	
	ControlSend,, {LControl Down}{t}{LControl Up}, The Settlers 7 Paths to a Kingdom Prima Official Guide - PDF-XChange Editor
	return
