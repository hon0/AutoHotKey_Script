...
{ ; Global remapping
	...
	{ ;Layer 1 "x" remapping
		...
		else
		{
			...
			sleep 32
			SendInput {x up}
			ControlSend, ahk_parent, {LControl Down}{LShift Down}{n}{LControl Up}{LShift Up}, The Settlers 7 Paths to a Kingdom Prima Official Guide - PDF-XChange Editor
			ControlSend,, 17, Aller à la page
	...
	y::
	;ControlSend, ahk_parent, {LControl Down}{LShift Down}{n}{LControl Up}{LShift Up}, new 1 - Notepad++
	ControlSend, ApplicationFrameInputSinkWindow1, {LControl Down}{g}{LControl Up}, The Settlers 7 Paths to a Kingdom Prima Official Guide.pdf et 1 page supplémentaire ‎- Microsoft Edge
	ControlSend, ApplicationFrameInputSinkWindow1, 12, The Settlers 7 Paths to a Kingdom Prima Official Guide.pdf et 1 page supplémentaire ‎- Microsoft Edge
	ControlSend,, {NumpadEnter}, The Settlers 7 Paths to a Kingdom Prima Official Guide.pdf et 1 page supplémentaire ‎- Microsoft Edge
	;ControlSend,, {NumpadEnter}, Aller à la page
	return	
