...
while !GetKeyState("z", "P")=1 && !GetKeyState("q", "P")=1 && !GetKeyState("s", "P")=1 && !GetKeyState("d", "P")=1
{
	Moving := 0
}
Else if GetKeyState("z", "P")=1 or !GetKeyState("q", "P")=1 or !GetKeyState("s", "P")=1 or !GetKeyState("d", "P")=1
{
	Moving := 1
}
Else
...
~*z::
{
	If Moving = 0 and Toggle_Walk = 1
	{
		Send {LShift}
		keywait z
		Return
	}
	Else if Moving = 1 and Toggle_Walk = 1
	{
