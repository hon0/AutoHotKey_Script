...
~LControl::
{
	If (LControl_pressed)
		Return
	LControl_pressed := 1
	ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *10, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Icon_1.png
	if (ErrorLevel = 2)
	{
		Quantity_ImageSearch := 0
...
~LShift::
{
	If (LShift_pressed)
		Return
	LShift_pressed := 1
	ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *200, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Quantity_Icon.bmp
	if (ErrorLevel = 2)
	{
			MsgBox Could not conduct the search.
		return
