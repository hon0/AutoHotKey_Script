...
#Persistent
{
	...
	LShift_ImageSearch := 0
	LControl_ImageSearch := 0
}
...
~LShift::
{
	If (LShift_pressed)
		Return
	LShift_pressed := 1
	ImageSearch, FoundX, FoundY, 1550, 400, A_ScreenWidth, A_ScreenHeight, *25, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Quantity_Icon.png
	if (ErrorLevel = 2)
	{
