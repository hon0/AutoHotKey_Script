...
LControl & c:: ; Caméra sur et selection de l'Ark	
{
	...
	If Toggle_Right = 1
	{
		Send {Blind}{NumpadSub Up}{LControl Down}{c}{LControl Up}{NumpadSub Down}
	}
	Else
	{
		Send {Blind}{LControl Down}{c}{LControl Up}
	}
	Return
}
...
SC002:: ; Faire défiler la sélection des Navires sans déplacer la caméra
{
	...
	Else If (Toggle_Right = 1) and (Layer = 2)
	{
		Toggle_Right := 0
	...
	Else If (Toggle_Right = 0) and (Layer = 2)
	{
		Send {F1}
		KeyWait SC002
	}
