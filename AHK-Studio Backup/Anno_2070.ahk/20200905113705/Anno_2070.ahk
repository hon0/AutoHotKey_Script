...
#z::	
ImageSearch, FoundX, FoundY, 0, 0, A_ScreenWidth, A_ScreenHeight, *25, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Icon_1.png
...
if (ErrorLevel = 2)
	...
	MouseGetPos, xpos, ypos 
	BlockInput, On
	MouseClick, left, %FoundX%+200, %FoundY%
	MouseMove, xpos, ypos 
	BlockInput, Off
	}
return
