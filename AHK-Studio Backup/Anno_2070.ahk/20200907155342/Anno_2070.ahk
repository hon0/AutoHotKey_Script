...
~LControl::
{
	If (LControl_pressed)
		Return
	LControl_pressed := 1
	ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *25, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Quantity_Icon.bmp
	if (ErrorLevel = 2)
	{
		Quantity_ImageSearch := 0
...
~LShift::
{
	If (LShift_pressed)
		Return
	LShift_pressed := 1
	ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *100, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Quantity_Icon.bmp
	if (ErrorLevel = 2)
	{
			;MsgBox Could not conduct the search.
		return
...
/*
	...
	#z::
	{
		;PixelSearch, Px, Py, 1500, 750, 1550, 1000, 0A2940, 20, Fast
	...
	*NumpadEnter:: ; Enter
	{
		...
		If Toggle_Right = 1
		{
			SendInput {Blind}{NumpadSub Up}{NumpadEnter}{NumpadSub Down}
		}
		Else
		{
