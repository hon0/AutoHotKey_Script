	...
	*$SC002:: ; Layer 1 = Faire défiler la sélection des Navires. Layer 2 = Vue carte postale.
	{
		...
		If (Layer = 1)
		{
			...
			If ErrorLevel
			{
				ImageSearch, FoundX, FoundY, 683, 946, 1223, 1074, *100, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Eco-ctr-icon.png
				if (ErrorLevel = 2)
				{
				;MsgBox Could not conduct the search.
					return
	...
	*$SC003:: ; Layer 1 = Décharger toutes les marchandises du véhicule dans l'entrepot à portée.
	{
		...
		If (Layer = 1)
		{
			...
			If ErrorLevel
			{
				ImageSearch, FoundX, FoundY, 683, 946, 1223, 1074, *100, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Tycoon-ctr-icon.png
				if (ErrorLevel = 2)
				{
				;MsgBox Could not conduct the search.
					return
	...
	*$SC004:: ; Groupe 3
	{
		...
		If (Layer = 1)
		{
			...
			If ErrorLevel
			{
				ImageSearch, FoundX, FoundY, 683, 946, 1223, 1074, *100, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Tech-ctr-icon.png
				if (ErrorLevel = 2)
				{
				;MsgBox Could not conduct the search.
					return
	...
	*Right:: ; Toggle time deceleration
	{
		...
		If ErrorLevel
		{
			ImageSearch, FoundX, FoundY, 1500, 750, A_ScreenWidth, A_ScreenHeight, *100, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Quitter_route_commerciale.png
			if (ErrorLevel = 2)
			{
				;MsgBox Could not conduct the search.
				return
			...
			{
				ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *100, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Quitter_route_commerciale_bis.png
				if (ErrorLevel = 2)
				{
					return
				}
