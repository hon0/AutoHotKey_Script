...
{ ; Keypad and/or Keyboard.
	~LControl::
	{
		If (LControl_pressed)
			Return
		LControl_pressed := 1
		ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *75, D:\Dropbox\Anno 2070\AutoHotKey Image SearchQuantity_Icon.bmp
		if (ErrorLevel = 2)
		{
			Quantity_ImageSearch := 0
		...
		;MsgBox Icon could not be found on the screen.
			ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *75, D:\Dropbox\Anno 2070\AutoHotKey Image SearchQuantity_Icon_10.bmp
			if (ErrorLevel = 2)
			{
				Quantity_ImageSearch := 0
		;MsgBox Could not conduct the search.
	...
	~LShift Up::
	{
		...
		If Quantity_ImageSearch = 1
		{
		;ImageSearch, FoundX, FoundY, 1550, 400, A_ScreenWidth, A_ScreenHeight, *25, D:\Dropbox\Anno 2070\AutoHotKey Image SearchIcon_1.png
			{
		;MsgBox The icon was found at %FoundX%x%FoundY%.
				{
					MouseGetPos, xpos, ypos 
	...
	*$SC002:: ; Layer 1 = Faire défiler la sélection des Navires. Layer 2 = Vue carte postale.
	{
		...
		If (Layer = 1)
		{
			...
			If ErrorLevel
			{
				ImageSearch, FoundX, FoundY, 683, 946, 1223, 1074, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchEco-ctr-icon.png
				if (ErrorLevel = 2)
				{
				;MsgBox Could not conduct the search.
					return
	...
	*$SC003:: ; Layer 1 = Décharger toutes les marchandises du véhicule dans l'entrepot à portée.
	{
		...
		If (Layer = 1)
		{
			...
			If ErrorLevel
			{
				ImageSearch, FoundX, FoundY, 683, 946, 1223, 1074, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchTycoon-ctr-icon.png
				if (ErrorLevel = 2)
				{
				;MsgBox Could not conduct the search.
					return
	...
	*$SC004:: ; Groupe 3
	{
		...
		If (Layer = 1)
		{
			...
			If ErrorLevel
			{
				ImageSearch, FoundX, FoundY, 683, 946, 1223, 1074, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchTech-ctr-icon.png
				if (ErrorLevel = 2)
				{
				;MsgBox Could not conduct the search.
					return
	...
	*$SC005:: ; Groupe 4
	...
	$*e::
	{
		...
		If (Layer=1)
		{
			ImageSearch, FoundX, FoundY, 1500, 750, A_ScreenWidth, A_ScreenHeight, *25, D:\Dropbox\Anno 2070\AutoHotKey Image SearchIcon_Load.png
			if (ErrorLevel = 2)
			{
				;MsgBox Could not conduct the search.
				return
			...
			{
				;MsgBox Icon could not be found on the screen.
				ImageSearch, FoundX, FoundY, 1500, 750, A_ScreenWidth, A_ScreenHeight, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchTransaction_Icon.png
				if (ErrorLevel = 2)
				{
				;MsgBox Could not conduct the search.
					return
	...
	*Left:: ; Ouvrir la flotte de véhicule et les bâtiments.
	{
		...
		If ErrorLevel
		{
			ImageSearch, FoundX, FoundY, 1500, 750, A_ScreenWidth, A_ScreenHeight, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchRoute_Commercial_02.png
			if (ErrorLevel = 2)
			{
				;MsgBox Could not conduct the search.
				return
			...
			{
				ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchRoute_Commercial_02_bis.png
				if (ErrorLevel = 2)
				{
					return
				}
				...
				{
					ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchRoute_Commercial_01.png
					if (ErrorLevel = 2)
					{
						return
					}
	...
	*Right:: ; Toggle time deceleration
	{
		If (Right_pressed)
			return
		Right_pressed := 1
		KeyWait Right, t0.100
		t:= A_TimeSinceThisHotkey
		If ErrorLevel
		{
			ImageSearch, FoundX, FoundY, 1500, 750, A_ScreenWidth, A_ScreenHeight, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchQuitter_route_commerciale.png
			if (ErrorLevel = 2)
			{
				;MsgBox Could not conduct the search.
				return
			...
			{
				ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchQuitter_route_commerciale_bis.png
				if (ErrorLevel = 2)
				{
					return
				}
	...
	*Space:: ; Tempo : Centrer la caméra sur la dernière notification ; Pause ou reprise de la route commerciale
	{
		...
		If ErrorLevel
		{
			ImageSearch, FoundX, FoundY, 1500, 750, A_ScreenWidth, A_ScreenHeight, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchPause_Route_Commerciale.png
			if (ErrorLevel = 2)
			{
				;MsgBox Could not conduct the search.
				return
			...
			{
				ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchPause_Route_Commerciale_bis.png
				if (ErrorLevel = 2)
				{
					return
				}
				...
				{
					ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchResume_Route_Commerciale.png
					if (ErrorLevel = 2)
					{
						return
					}
					...
					{
						ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *100, D:\Dropbox\Anno 2070\AutoHotKey Image SearchResume_Route_Commerciale_bis.png
						if (ErrorLevel = 2)
						{
							return
						}
