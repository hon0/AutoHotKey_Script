	...
	*Left:: ; Ouvrir la flotte de véhicule et les bâtiments.
	{
		...
		If ErrorLevel
		{
			ImageSearch, FoundX, FoundY, 1500, 750, A_ScreenWidth, A_ScreenHeight, *50, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Route_Commercial_02.png
			if (ErrorLevel = 2)
			{
				;MsgBox Could not conduct the search.
				return
			...
			{
				ImageSearch, FoundX, FoundY, 1550, 575, A_ScreenWidth, A_ScreenHeight, *75, E:\- Téléchargements sur E\Anno 2070\AutoHotKey Image Search\Route_Commercial_01.png
				if (ErrorLevel = 2)
				{
					return
				}
