...
Tab:: ; Faire défiler la sélection des Entrepôts et centrer la caméra sur la sélection
{
	If Toggle_LAlt = 1
	{
		Toggle_LAlt := 0
...
LAlt & Tab:: ; Faire défiler la sélection des Entrepôts et centrer la caméra sur la sélection
{
	If Toggle_LAlt = 1
	{
		Toggle_LAlt := 0
...
LControl & Tab:: ; Faire défiler et centrer la caméra sur les Entrepôts sans les sélectionner
{
	If Toggle_LAlt = 1
	{
		Toggle_LAlt := 0
...
SC002:: ; Faire défiler la sélection des Navires sans déplacer la caméra
{
	...
	{
		Toggle_LAlt := 0
		Send {NumpadSub Up}{LShift Down}{TAB}{LShift Up}{NumpadSub Down}
		Toggle_LAlt := 1
		KeyWait SC002
	}
	Else
...
LControl & f:: ; Faire défiler la sélection des Navires et centrer la caméra sur la sélection
{
	If Toggle_LAlt = 1
	{
		Toggle_LAlt := 0
...
LShift & f:: ; Faire défiler la sélection des Navires sans déplacer la caméra
{
	If Toggle_LAlt = 1
	{
		Toggle_LAlt := 0
...
LAlt & f:: ; Faire défiler la sélection des Navires inactif et centrer la caméra
{
	If Toggle_LAlt = 1
	{
		Toggle_LAlt := 0
