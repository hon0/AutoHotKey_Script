...
{ ; Keypad and/or Keyboard.
	...
	*$SC029:: ; Déselectionner, menu.
	{
		...
		If ErrorLevel
		{
			If Toggle_Right = 1
			{
				SendInput {NumpadSub Up}{p}{NumpadSub Down}
			}
			Else
			{
				SendInput {p}
	...
	*$SC029 Up::
	...
	LControl & Tab:: ; Faire défiler les Navires sans les selectionner et centrer la caméra sur eux.
	{
		If (Tab_pressed)
			Return
		Tab_pressed := 1
	...
	LControl & SC004:: ; Groupe 3
	{
		...
		If Toggle_Right = 1
		{
			SendInput {NumpadSub Up}{LControl Down}{SC004}{LControl Up}{NumpadSub Down}
		}
		Else
		{
			SendInput {LControl Down}{SC004}{LControl Up}
		}
		Return
	}
	...
	LControl & SC005:: ; Groupe 3
	{
		...
		If Toggle_Right = 1
		{
			SendInput {NumpadSub Up}{LControl Down}{SC005}{LControl Up}{NumpadSub Down}
		}
		Else
		{
			SendInput {LControl Down}{SC005}{LControl Up}
		}
		Return
	}
	...
	SC002:: ; Layer 1 = Faire défiler la sélection des Navires. Layer 2 = Vue carte postale.
	{
		...
		If (Layer = 1)
		{
			If (Toggle_Right = 1)
			{
				SendInput {NumpadSub Up}{Numpad0}{NumpadSub Down}
			}
			Else
			{
				SendInput {Numpad0}
	...
	SC004:: ; Groupe 3
	{
		...
		If (Layer = 1)
		{
			If (Toggle_Right = 1)
			{
				SendInput {NumpadSub Up}{SC004}{NumpadSub Down}
			}
			Else
			{
				SendInput {SC004}
	...
	SC005:: ; Groupe 4
	{
		...
		If (Layer = 1)
		{
			If (Toggle_Right = 1)
			{
				SendInput {NumpadSub Up}{SC005}{NumpadSub Down}
			}
			Else
			{
				SendInput {SC005}
	...
	*$Insert::
	{
		If (Layer = 1)
		{
			If (Toggle_Right = 1)
			{
				SendInput {NumpadSub Up}{v}{NumpadSub Down}
				Sleep 200
			}
			Else
			{
		...
		If (Layer = 2)
		{
			If (Toggle_Right = 1)
			{
				SendInput {NumpadSub Up}{SC033}{NumpadSub Down}
				Sleep 200
			}
			Else
			{
	...
	*Down:: ; Ouvrir la carte stratégique.
	{
		...
		If Toggle_Right = 1
		{
			SendInput {Blind}{NumpadSub Up}{Down}{NumpadSub Down}
		}
		Else
		{
			SendInput {Blind}{Down}
	...
	*NumpadEnter:: ; Enter
	{
		...
		If Toggle_Right = 1
		{
			SendInput {Blind}{NumpadSub Up}{NumpadEnter}{Escape}{NumpadSub Down}
		}
		Else
		{
