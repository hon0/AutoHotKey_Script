...
F1:: ; " Scout selection
{
	...
	if (ErrorLevel)
	{
		Send {LControl Down}{F1}{Numpad2}{LAlt Down}{Numpad2}{LAlt Up}{LControl Up} ; Select Only Land Scout
	}
	else {
		KeyWait, F1, D T0.1
		...
		if (ErrorLevel)
		{
			Send {LControl Down}{F1}{Numpad1}{LAlt Down}{Numpad4}{LAlt Up}{LControl Up} ; Select Only Air Scout
		}
