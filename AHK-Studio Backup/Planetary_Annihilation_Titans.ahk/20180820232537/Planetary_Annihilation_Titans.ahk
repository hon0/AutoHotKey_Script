...
F3:: ; Short press to select non normal Naval factories, Long press to select advanced Naval factories
{
	...
	If ErrorLevel
	{
		If GetKeyState("MButton", "P")=1
		{
			Sendinput {MButton Down}{LControl Down}{F1}{Numpad3}{LAlt Down}{Numpad4}{LAlt Up}{Numpad5}{LControl Up}{MButton Up}
			keywait F3
		}
		Else
		{
	...
	Else
	{
		If GetKeyState("MButton", "P")=1
		{
			Sendinput {MButton Down}{LControl Down}{F1}{Numpad3}{LAlt Down}{Numpad5}{LAlt Up}{LControl Up}{MButton Up}
			keywait F3
		}
		Else
		{
