...
~Enter:: ; Open Global Chat Windows
{
...
RShift & Enter:: ; Open Team Chat Windows
{
	If WinActive("Planetary Annihilation")
	{
		Send {RShift Up}{RShift}{Enter}
		InChat := !InChat
	...
	Else
	{
		SendInput {RShift Down}{Enter Down}
		KeyWait, Enter
		SendInput {Enter Up}{RShift Up}
	}
	Return
}
