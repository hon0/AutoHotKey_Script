...
~LButton Up:: ; Selection filter
{
	...
	{
		Sleep 67
		Send {LControl Down}{LAlt Down}{Numpad2}{LAlt Up}{LControl Up}{j}
		BomberFilter := 0
		Return
	}
	...
	{
		Sleep 67
		Send {LControl Down}{LAlt Down}{Numpad2}{LAlt Up}{LControl Up}{j}{u}
		BomberFilter := 0
		Return
	}
	...
	{
		Sleep 67
		Send {LControl Down}{LAlt Down}{Numpad2}{LAlt Up}{LControl Up}{j}{k}
		BomberFilter := 0
		Return
	}
	Return
