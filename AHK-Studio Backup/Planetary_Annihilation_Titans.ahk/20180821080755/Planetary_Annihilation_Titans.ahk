...
*F13:: ; Heavies selection, See LButton Filter
{
	...
	If (ErrorLevel) ; Select Vanguard
	{
		If GetKeyState("MButton", "P")=1
		{
			Sendinput {MButton Up}{LControl Down}{LShIft Down}{F10}{LShIft Up}{Numpad8}{LControl Up}{j}{MButton Down}
			HeavyFilter := 2
			KeyWait F13
		}
		Else
		{
			Sendinput {LControl Down}{LShIft Down}{F10}{LShIft Up}{Numpad8}{LControl Up}{j}
			HeavyFilter := 2
			KeyWait F13
		}
	}
