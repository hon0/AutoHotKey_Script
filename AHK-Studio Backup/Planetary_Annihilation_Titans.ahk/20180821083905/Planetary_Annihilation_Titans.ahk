...
{
	If GetKeyState("F24", "P")=1 ; Selection filter ?
	{
		Send {u}
		Return
	}
	...
	Else	If HeavyFilter = 2 ; Selection filter Leveler
	{
		Sleep 67
	...
	Else	If HeavyFilter = 1 ; Selection filter Ant
	{
		Sleep 67
		Send {LControl Down}{Numpad9}{LControl Up}
		Sleep 32
	...
	Else	If HeavyFilter = 3 ; Selection filter Drifter
	{
		Sleep 67
		Send {LControl Down}{Numpad9}{LControl Up}
		Sleep 32
