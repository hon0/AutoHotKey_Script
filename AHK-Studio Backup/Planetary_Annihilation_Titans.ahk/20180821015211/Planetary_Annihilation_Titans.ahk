...
~LButton Up:: ; Selection filter
{
	...
	{
		Send {h}{LControl Down}{Numpad2}{Numpad5}{LControl Up}
		FighterFilter := 0
		Return
	}
	Else	If FighterFilter = 3 ; Selection filter Orbital Fighter
	{
		Send {h}{LControl Down}{Numpad4}{LControl Up}
		FighterFilter := 0
		Return
	}
	Else	If FighterFilter = 1 ; Selection filter Air Fighter
	{
		Send {y}
		FighterFilter := 0
		Return
