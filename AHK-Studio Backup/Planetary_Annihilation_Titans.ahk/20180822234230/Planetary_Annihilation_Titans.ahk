...
~LButton Up:: ; Selection filter
{
	...
	{
		Sleep 67
		SendInput {LShift Up}{LControl Down}{Numpad2}{Numpad5}{LControl Up}
		Send {h}
		FighterFilter := 0
		Return
	}	
	...
	{
		Sleep 67
		SendInput {LShift Up}{LControl Down}{Numpad2}{LControl Up}
		;Sleep 32
		Send {y}
		FighterFilter := 0
		Return
	...
	{
		Sleep 67
		Send {LShift Up}{LControl Down}{Numpad4}{LControl Up}
		Sleep 32
		Send {y}
		FighterFilter := 0
		Return
