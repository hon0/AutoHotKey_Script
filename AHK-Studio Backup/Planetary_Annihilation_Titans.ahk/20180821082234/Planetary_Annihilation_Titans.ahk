...
SC005:: ; Fighter selection, See LButton Filter
{
	...
	Else ; Select HummmingBird
	{
		...
		If (ErrorLevel)
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{SC005}{SC005}{LControl Down}{Numpad2}{LControl Up}{y}
				If GetKeyState("MButton", "P")=1
				{
					Send {MButton Down}
				}
...
SC006:: ; Air bomber selection, See LButton Filter
{
	...
	If (ErrorLevel) ; Select Kestrel
	{
		If GetKeyState("MButton", "P")=1
		{
			Send {MButton Up}{LControl Down}{LShIft Down}{F9}{LShIft Up}{LControl Up}{j}
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Down}
			}
		...
		Else
		{
			Send {LControl Down}{LShIft Down}{F9}{LShIft Up}{LControl Up}{j}
			BomberFilter := 2
			KeyWait SC006
		}
	}
	Else 
	{
		...
		If (ErrorLevel) ; Select BumbleBee
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{LControl Down}{LShIft Down}{F9}{LShIft Up}{LControl Up}{u}
				If GetKeyState("MButton", "P")=1
				{
					Send {MButton Down}
				}
			...
			Else
			{
				Send {LControl Down}{LShIft Down}{F9}{LShIft Up}{LControl Up}{u}
				BomberFilter := 1
				KeyWait SC006
			}
		}
		Else ; Select Hornet
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{LControl Down}{LShIft Down}{F9}{LShIft Up}{LControl Up}{k}
				If GetKeyState("MButton", "P")=1
				{
					Send {MButton Down}
				}
			...
			Else
			{
				Send {LControl Down}{LShIft Down}{F9}{LShIft Up}{LControl Up}{kj}
				BomberFilter := 3
				KeyWait SC006
			}
		}
...
F13:: ; Heavies selection, See LButton Filter
{
	...
	If (ErrorLevel) ; Select Vanguard
	{
		If GetKeyState("MButton", "P")=1
		{
			Send {MButton Up}{LControl Down}{LShIft Down}{F10}{LShIft Up}{Numpad8}{LControl Up}{j}
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Down}
			}
		...
		Else
		{
			Send {LControl Down}{LShIft Down}{F10}{LShIft Up}{Numpad8}{LControl Up}{j}
			HeavyFilter := 2
			KeyWait F13
		}
	}
	Else 
	{
		...
		If (ErrorLevel) ; Select Inferno
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{LControl Down}{LShIft Down}{F10}{LShIft Up}{Numpad8}{LControl Up}{u}
				If GetKeyState("MButton", "P")=1
				{
					Send {MButton Down}
				}
			...
			Else
			{
				Send {LControl Down}{LShIft Down}{F10}{LShIft Up}{Numpad8}{LControl Up}{u}
				HeavyFilter := 1
				KeyWait F13
			}
		}
		Else ; Select Spark
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{LControl Down}{LShIft Down}{F10}{LShIft Up}{Numpad8}{LControl Up}{p}
				If GetKeyState("MButton", "P")=1
				{
					Send {MButton Down}
				}
			...
			Else
			{
				Sendinput {LControl Down}{LShIft Down}{F10}{LShIft Up}{Numpad8}{LControl Up}{p}
				HeavyFilter := 3
				KeyWait F13
			}
		}
...
{
	If GetKeyState("F14", "P")=1 ; Selection filter ?
	{
		Send {u}
		Return
	}
