...
{
	If (InChat = 0) and WinActive("Planetary Annihilation")
	{
		KeyWait, SC004, T0.1
...
{
	If (Layer = 1) and (InChat = 0) and WinActive("Planetary Annihilation")
	{
...
~LButton Up:: ; Selection filter
{
	...
	{
		Sleep 67
		SendInput {LButton Up}{LShift Up}{LControl Down}{Numpad2}{Numpad5}{LControl Up}
		Send {h}
		FighterFilter := 0
		Return
	}	
	...
	{
		Sleep 67
		SendInput {LButton Up}{LShift Up}{LControl Down}{Numpad2}{LControl Up}
		;Sleep 32
		Send {y}
		FighterFilter := 0
		Return
	...
	{
		Sleep 67
		Send {LButton Up}{LShift Up}{LControl Down}{Numpad4}{LControl Up}
		Sleep 32
		Send {y}
		FighterFilter := 0
		Return
	...
	{
		Sleep 67
		Send {LButton Up}{LShift Up}{LAlt Down}{Numpad3}{LAlt Up}{LControl Down}{Numpad1}{LControl Up}
		Sleep 67
		Send {i}
		ScoutFilter := 0
		Return
	...
	{
		Sleep 67
		Send {LButton Up}{LShift Up}{LAlt Down}{Numpad3}{LAlt Up}{LControl Down}{Numpad2}{LControl Up}
		Sleep 67
		Send {i}
		ScoutFilter := 0
		Return
