...
F13:: ; Scout selection
{
	...
	If (ErrorLevel) ; Select Vanguard
	{
		If GetKeyState("MButton", "P")=1
		{
			Sendinput {MButton Up}{LControl Down}{LShIft Down}{F9}{LShIft Up}{Numpad8}{LControl Up}{MButton Down}
			BomberFilter := 2
			KeyWait F13
		}
		Else
		{
			Sendinput {LControl Down}{LShIft Down}{F9}{LShIft Up}{Numpad8}{LControl Up}
			BomberFilter := 2
			KeyWait F13
		}
	}
	Else 
	{
		...
		If (ErrorLevel) ; Select Inferno
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{LControl Down}{Numpad8}{LControl Up}{MButton Down}
				BomberFilter := 1
				KeyWait F13
			}
			Else
		...
		Else ; Select Spark
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{SC004}{LControl Down}{Numpad8}{LControl Up}{MButton Down}
				BomberFilter := 3
				KeyWait F13
			}
			Else
