...
$SC005:: ; Air Fighter selection
{
	...
	Else 
	{
		...
		If (ErrorLevel)
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{SC005}{SC005}{MButton Down} ; Select Air and Oribtal Fighter
				FighterFilter := 1
				keywait SC005
			}
			Else
		...
		Else
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{SC005}{SC005}{MButton Down} ; Select Orbital Fighter
				FighterFilter := 3
				keywait SC005
			}
			Else
...
~LButton Up:: ; Selection filter
{
	...
	{
		sleep 50
		Send {y}{LControl Down}{Numpad2}{LControl Up}
		FighterFilter := 0
		Return
	}
	...
	{
		sleep 50
		Send {y}{LControl Down}{Numpad4}{LControl Up}
		FighterFilter := 0
		Return
	}
