...
/*
	...
	{
		Send {LControl Down}{F1}{Numpad1}{LAlt Down}{Numpad4}{LAlt Up}{LControl Up}
		Return
	}
*/
...
F1:: ; " Scout selection
{
	...
	if (ErrorLevel)
	{
		Send {LControl Down}{F1}{Numpad1}{LAlt Down}{Numpad4}{LAlt Up}{Numpad5}{LControl Up} ; Select Only Land Scout
	}
	else {
		KeyWait, F1, D T0.1
		...
		if (ErrorLevel)
		{
			Send {LControl Down}{F1}{Numpad1}{LAlt Down}{Numpad4}{Numpad5}{LAlt Up}{LControl Up} ; Select Only Air Scout
		}
		
		else
		{
			Send {LControl Down}{F1}{Numpad3}{LAlt Down}{Numpad4}{LAlt Up}{LControl Up} ; Select Only Orbital Scout
		}
...
{
	Send {LControl Down}{F1}{Numpad4}{LControl Up}
	Return
}
