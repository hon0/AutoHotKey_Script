...
SC029 & F13:: ; Naval heavies
{
	...
	If (ErrorLevel) ; Select Leviathan
	{
		If GetKeyState("MButton", "P")=1
		{
			Send {MButton Up}{LControl Down}{LShIft Down}{F11}{LShIft Up}{Numpad8}{LControl Up}
			Sleep 67
			Send {h}
			If GetKeyState("MButton", "P")=1
			{
	...
	Else 
	{
		...
		Else ; Select Typhoon
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{LControl Down}{LShIft Down}{F11}{LShIft Up}{Numpad9}{LControl Up}
				Sleep 67
				Send {n}
				If GetKeyState("MButton", "P")=1
				{
			...
			Else
			{
				Send {LControl Down}{LShIft Down}{F11}{LShIft Up}{Numpad9}{LControl Up}
				Sleep 67
				Send {n}
				HeavyFilter := 3
				KeyWait F13
...
F18:: ; Support Fire Bot selection, See LButton Filter
{
	KeyWait, F18, T0.1
