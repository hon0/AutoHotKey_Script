...
SC005:: ; Fighter selection, See LButton Filter
{
	...
	Else ; Select HummmingBird
	{
		...
		Else ; Select Avenger
		{
			If GetKeyState("MButton", "P")=1
			{
				SendInput {MButton Up}{LControl Down}{LShift Down}{F12}{F12}{LShift Up}{LControl Up}{LAlt Down}{Numpad4}{LAlt Up}
				; SendInput {MButton Up}{SC005}{SC005}{LControl Down}{Numpad4}{LControl Up}
				;Sleep 32
				;Send {y} 
				If GetKeyState("MButton", "P")=1
				{
