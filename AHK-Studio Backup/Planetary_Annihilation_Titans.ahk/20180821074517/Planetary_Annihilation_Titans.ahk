...
SC005:: ; Fighter selection, See LButton Filter
{
	...
	If (ErrorLevel) ; Select Phoenix
	{
		If GetKeyState("MButton", "P")=1
		{
			Send {MButton Up}{SC005}{SC005}{LControl Down}{Numpad2}{LControl Up}{h}{MButton Down} 
			FighterFilter := 2
			KeyWait SC005
			Send {SC005 Up}
		}
	...
	Else ; Select HummmingBird
	{
		...
		If (ErrorLevel)
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{SC005}{SC005}{LControl Down}{Numpad2}{LControl Up}{y}{MButton Down}
				FighterFilter := 1
				KeyWait SC005
			}
			Else
		...
		Else ; Select Avenger
		{
			If GetKeyState("MButton", "P")=1
			{
				Send {MButton Up}{SC005}{SC005}{LControl Down}{Numpad4}{LControl Up}{y}{MButton Down}
				FighterFilter := 3
				KeyWait SC005
			}
			Else
