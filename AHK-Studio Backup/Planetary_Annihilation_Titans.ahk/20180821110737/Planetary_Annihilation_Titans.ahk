...
~LButton Up:: ; Selection filter
{
	...
	Else	If NavalHeaviesFilter = 2 ; Selection filter Kraken
	{
		Sleep 67
		Send {LControl Down}{Numpad3}{LControl Up}
		Sleep 67
	...
	Else	If NavalHeaviesFilter = 1 ; Selection filter Barracuda
	{
		Sleep 67
		Send {LControl Down}{Numpad3}{LControl Up}
		Sleep 67
	...
	Else	If NavalHeaviesFilter = 3 ; Selection filter ?
	/*
		{
			Sleep 67
			Send {LControl Down}{Numpad3}{LControl Up}
