...
LAlt & f:: ; Air, Sea, Land Fabricator selection, See LButton Filter
{
	...
	Else 
	{
		...
		Else ; Select Sea Fabricator
		{
			...
			Else
			{
				Send {LAlt Down}{f}{LAlt Up}{LControl Down}{Numpad3}{LControl Up}
				SeaFabricatorFilter := 1
				KeyWait f
			}
		}
...
~LButton:: ; Selection Filter
{
	...
	{
		Sendinput {LButton Down}{LButton Up}{LButton Down}{LShift Down}
	}
	...
	{
		Sendinput {LButton Down}{LButton Up}{LButton Down}{LButton Up}{LButton Down}{LShift Down}
	}
...
~LButton Up:: ; Selection filter
{
	...
	{
		Sleep 67
		Send {LShift Up}{LControl Down}{Numpad2}{f}{LControl Up}
		AirFabricatorFilter := 0
		Return
	}
	...
	{
		Sleep 67
		Send {LShift Up}{LControl Down}{Numpad1}{f}{i}{k}{LControl Up}
		LandFabricatorFilter := 0
		Return
	}
	Else	If SeaFabricatorFilter = 1 ; Selection filter Sea Fabricator
	{
		Sleep 67
		Send {LShift Up}{LControl Down}{Numpad3}{f}{p}{LControl Up}
		SeaFabricatorFilter := 0
		Return
	}
	...
	{
		Sleep 67
		Send {LShift Up}{LControl Down}{Numpad4}{f}{LControl Up}
		OrbitalFabricatorFilter := 0
		Return
	}
	Return
