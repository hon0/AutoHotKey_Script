...
F1:: ; Cycle unit one by one, long press to center on selection
{
	KeyWait F1, t0.100
	t:= A_TimeSinceThisHotkey
	If ErrorLevel
	{
		Send {LControl Down}{F1}{Numpad1}{LAlt Down}{Numpad4}{LAlt Up}{Numpad5}{LControl Up}
		keywait F1
	}
	else
	{
...
F2:: ; Cycle unit one by one, long press to center on selection
{
	KeyWait F2, t0.100
	t:= A_TimeSinceThisHotkey
	If ErrorLevel
	...
	{
		Send {LControl Down}{F1}{Numpad2}{LAlt Down}{Numpad4}{Numpad5}{LAlt Up}{LControl Up}
	}
	return
}

F3:: ; Cycle unit one by one, long press to center on selection
{
	KeyWait F3, t0.100
	t:= A_TimeSinceThisHotkey
	If ErrorLevel
...
F4:: ; Cycle unit one by one, long press to center on selection
{
	KeyWait F4, t0.100
	t:= A_TimeSinceThisHotkey
	If ErrorLevel
	{
		Send {LControl Down}{F1}{Numpad4}{LAlt Down}{Numpad4}{LAlt Up}{Numpad5}{LControl Up}
		keywait F4
	}
	else
	{
		Send {LControl Down}{F1}{Numpad4}{LAlt Down}{Numpad4}{Numpad5}{LAlt Up}{LControl Up}
	}
	return
}
...
$esc:: ; Short press to clear build queue, long press to toggle game menu
{
	KeyWait esc, t0.100
	t:= A_TimeSinceThisHotkey
	If ErrorLevel
...
$SC004:: ; " Scout selection
{
	...
	if (ErrorLevel)
	{
		Send {SC004}{LControl Down}{Numpad1}{LControl Up} ; Select Only Land Scout
	}
	else {
		...
		if (ErrorLevel)
		{
			Send {SC004}{LControl Down}{Numpad2}{LControl Up} ; Select Only Air Scout
		}
		
		else
		{
			Send {SC004}{LControl Down}{Numpad4}{LControl Up} ; Select Only Orbital Scout
		}
