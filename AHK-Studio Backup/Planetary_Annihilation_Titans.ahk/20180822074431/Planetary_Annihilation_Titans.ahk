...
~LButton:: ; Selection Filter
{
	...
	{
		Send {Backspace}{LButton Down}{LShift Down}
	}
...
~LButton Up:: ; Selection filter
{
	...
	{
		Sleep 67
		Send {LShift Up}{LButton Up}{LControl Down}{Numpad1}{f}{i}{k}{LControl Up}
		LandFabricatorFilter := 0
		Return
	}
	Else	If SeaFabricatorFilter = 1 ; Selection filter Sea Fabricator
	...
	{
		Sleep 67
		Send {LButton Up}{LShift Up}{LControl Down}{Numpad4}{f}{LControl Up}
		OrbitalFabricatorFilter := 0
		Return
	}
	Return
