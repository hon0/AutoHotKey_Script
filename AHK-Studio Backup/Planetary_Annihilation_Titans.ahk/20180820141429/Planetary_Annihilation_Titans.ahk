...
F1:: ; Short press to select non normal land factories, Long press to select advanced land factories.
{
	KeyWait F1, t0.100
...
{
	Sendinput {LControl down}{LShift Down}{z}{LShift Up}{LControl up}
	Sleep 200
	Return
}
