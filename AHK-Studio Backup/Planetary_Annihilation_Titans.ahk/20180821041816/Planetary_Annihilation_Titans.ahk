...
LControl & s:: ; Select all matching unit on screen then on planet.
{
	Send {esc}
	keywait s
	Return
...
~LButton Up:: ; Selection filter
{
	...
	Else	If FighterFilter = 3 ; Selection filter Air Fighter
	{
		Sleep 67
		Send {y}
		SendInput {LControl Down}{Numpad4}{LControl Up}
		FighterFilter := 0
		Return
	}
	...
	{
		Sleep 67
		Sendinput {LControl Down}{LShift Down}{F9}{LShift Up}{LControl Up}{j}
		BomberFilter := 0
		Return
	}
	...
	{
		Sleep 67
		Sendinput {LControl Down}{LShift Down}{F9}{LShift Up}{LControl Up}{y}
		BomberFilter := 0
		Return
	}
	...
	{
		Sleep 67
		Sendinput {LControl Down}{LShift Down}{F9}{LShift Up}{LControl Up}{k}
		BomberFilter := 0
		Return
	}
	Return
