...
F1::
{
	...
	If (ErrorLevel)
	{
		...
		{
			Sendinput {MButton Up}{LControl Down}{F1}{Numpad1}{LAlt Down}{Numpad4}{LAlt Up}{Numpad5}{LControl Up}{MButton Down}
			keywait F2
		}
		Else
		{
			Sendinput {LControl Down}{F1}{Numpad1}{LAlt Down}{Numpad4}{LAlt Up}{Numpad5}{LControl Up}
			keywait F2
		}
	}
	Else {
