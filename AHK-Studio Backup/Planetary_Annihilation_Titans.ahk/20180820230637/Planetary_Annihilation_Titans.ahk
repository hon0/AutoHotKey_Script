...
F1::
{
	...
	If (ErrorLevel)
	{
		...
		{
			Sendinput {MButton Up}{LControl Down}{F1}{Numpad1}{LAlt Down}{{LAlt Up}{LControl Up}{MButton Down}
			keywait F1
		}
		Else
		{
			Sendinput {LControl Down}{F1}{Numpad1}{LAlt Down}{LAlt Up}{LControl Up}
			keywait F1
		}
	}
	Else {
