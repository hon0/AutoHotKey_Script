...
~LButton Up:: ; Selection filter
{
	...
	Else	If NavalSupportFireFilter = 2 ; Selection filter Kaiju
	{
		Sleep 67
		Send {LControl Down}{Numpad3}{LControl Up}
		Sleep 67
	...
	Else	If NavalSupportFireFilter = 1 ; Selection filter Piranha
	{
		Sleep 67
		Send {LControl Down}{Numpad3}{LControl Up}
		Sleep 67
	...
	Else	If NavalSupportFireFilter = 3 ; Selection filter Barnacle
	{
		Sleep 67
		Send {LControl Down}{Numpad3}{LControl Up}
		Sleep 67
